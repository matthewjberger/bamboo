...
bump-patch-version:
    ...
    sed -i "s/bamboo-ssg = \"$CURRENT_VERSION\"/bamboo-ssg = \"$NEW_VERSION\"/" README.md
    cargo check --quiet
    git add crates/bamboo/Cargo.toml apps/cli/Cargo.toml README.md Cargo.lock
